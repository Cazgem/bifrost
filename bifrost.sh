...
SERVER_ENTRIES=(
	"DVLB-WS01|167.99.149.216||22"
	"Polyphony-tw01|207.154.201.115||22"
	"DFS|192.168.1.74||22"
	"DVLB-GT01|161.35.96.81||22"
	"DVLB-FS04|192.168.50.217||22"
	"ASUS RT-AX82U|192.168.50.1|Zach|4170"
	"DVLB-db-01|147.182.238.74|root|22"
	"DVLB-WS02|137.184.58.230||22"
)
...
ALIAS_ENTRIES=(
	...
	"dvlb-ws02|DVLB-WS02"
	"db|DVLB-db-01"
	"dvlb-db-01|DVLB-db-01"
	"router|ASUS RT-AX82U"
	"rt-ax82u|ASUS RT-AX82U"
)
